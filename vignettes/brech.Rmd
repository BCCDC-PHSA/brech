...
parallelized using the `future` package together with [`progressr`](https://progressr.futureverse.org/) to generate a progress bar. For more complex and realistic models these will be 
