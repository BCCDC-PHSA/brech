...
[![R-CMD-check](https://github.com/BCCDC-PHSA/brech/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/BCCDC-PHSA/brech/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
